function preg_split(pattern, subject, limit, flags) {
	...
	var result, ret = [], index = 0, i = 0,
		...
		OPTS = {}, optTemp = 0,
		delimiter = pattern[0],
		lastIndex = pattern.lastIndexOf(delimiter),
		regexpBody = pattern.substring(1, lastIndex),
		regexpFlags = pattern.substring(lastIndex + 1);
...
module.exports.preg_split = preg_split;
